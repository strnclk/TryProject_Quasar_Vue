<template>
    <div class="q-pa-md">
      <div class="text-h3 text-orange-14 text-center">Tab Adı Güncelleme Alanı</div>
      ...
      const addRow = async () => {
        try {
          ...
          const response = await axios.post(
            'http://localhost:5159/api/Admin/add-about2',
            newRow,
            {
      ...
      const deleteRow = async (row) => {
        try {
          ...
          const response = await axios.delete(
            'http://localhost:5159/api/Admin/remove-about2',
            {
              headers: {
      ...
      const updateRow= async ()=> {
        try {
          ...
          const response = await axios.put(
            "http://localhost:5159/api/Admin/update-about2",
            {

<template>
    <div class="q-pa-md">
      <div class="text-h3 text-orange-14 text-center">Footer Güncelleme Alanı</div>
      ...
      const addRow = async () => {
        try {
          ...
          const response = await axios.post(
            'http://localhost:5159/api/Admin/add-footer',
            newRow,
            {
      ...
      const deleteRow = async (row) => {
        try {
          ...
          const response = await axios.delete(
            'http://localhost:5159/api/Admin/remove-footer',
            {
              headers: {
      ...
      const updateRow= async ()=> {
        try {
          ...
          const response = await axios.put(
            "http://localhost:5159/api/Admin/update-footer",
            {

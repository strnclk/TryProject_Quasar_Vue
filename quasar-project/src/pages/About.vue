    ...
    >
      ...
      <template v-slot:before>
        <q-tabs
          v-model="tab"
          vertical
          class="text-orange-13"
        >
          <q-tab name="mails" icon="mail" label="Özgeçmişim" />
          <q-tab name="alarms" icon="alarm" label="Projelerim" />
        </q-tabs>
      </template>
      ...
      >
        <div>
          ...
          <q-tab-panel name="alarms">
            <div class="text-h4 q-mb-md">Projelerim</div>
